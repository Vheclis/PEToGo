...
curl -X PUT http://127.0.0.1:5984/petogo/"4" -d '{"typeDB": "product", "img":"https://goo.gl/utWvYW", "name" : "pedrigree", "shortDescription" : "Ração para doggos", "amount": 10 , "bigDescription":"Raaação para dooogos" , "price" : 59.90 }'
curl -X PUT http://127.0.0.1:5984/petogo/"5" -d '{"typeDB": "product", "img":"https://goo.gl/utWvYW", "name" : "pedrigree2", "shortDescription" : "Ração para doggos2", "amount": 10 , "bigDescription":"Raaação para dooogos2" , "price" : 59.903 }'
curl -X PUT http://127.0.0.1:5984/petogo/"6" -d '{"typeDB": "product", "img":"https://goo.gl/utWvYW", "name" : "pedrigree3", "shortDescription" : "Ração para doggos3", "amount": 10 , "bigDescription":"Raaação para dooogos3" , "price" : 59.903 }'
curl -X PUT http://127.0.0.1:5984/petogo/"7" -d '{"typeDB": "product", "img":"https://goo.gl/utWvYW", "name" : "dogshow", "shortDescription" : "Ração para doggos shows", "amount": 10 , "bigDescription":"Raaação para dooogos4" , "price" : 109.90 }'

curl -X PUT http://127.0.0.1:5984/petogo/"8" -d '{"typeDB": "service", "username" : "", "date" : "2017-06-10", "time" : "18:00", "type" : "Banho", "status" : "free"}'
curl -X PUT http://127.0.0.1:5984/petogo/"9" -d '{"typeDB": "service", "username" : "", "date" : "2017-06-10", "time" : "19:00", "type" : "Banho", "status" : "free"}'
curl -X PUT http://127.0.0.1:5984/petogo/"10" -d '{"typeDB": "service", "username" : "", "date" : "2017-06-10", "time" : "16:00", "type" : "Banho", "status" : "free"}'
